...
@click.option('--datafile1', help='Which file would you like this file to be saved to?')
@click.option('--datafile2', help='Which file would you like this file to be saved to?')

def main(dataread,dataout,datafile1, datafile2):
    ...
    energy_test.to_csv(datafile1)  
    energy_train.to_csv(datafile2)
