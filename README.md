...
python eda.py --data_path=scripts/data/processesed/energy_train.csv --output_path=result/EDA.png

python linear_regression.py --training_data_path=scripts/data/processesed/energy_train.csv --test_data_path=data/processesed/energy_test.csv --output_path=result/result.png
